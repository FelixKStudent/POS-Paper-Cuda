...
include::FirstSteps\CudaHelloWorld\CudaHelloWorld\kernel.cu[lines=4..6, indent = 1]
...
include::FirstSteps\CudaHelloWorld\CudaHelloWorld\kernel.cu[lines=14..25, indent = 1]

cudaMalloc is very similar to the normal malloc function. It is used to first allocate space on the GPU for us to later place data into. It takes two inputs, first a pointer a to a pointer is provided, which after execution of the function will be set to the location in memory that was allocated, second the size in bytes we need to allocate. 
...
include::FirstSteps\CudaHelloWorld\CudaHelloWorld\kernel.cu[lines=28..31, indent = 1]
...
include::FirstSteps\CudaHelloWorld\CudaHelloWorld\kernel.cu[lines=8..12, indent =1]
...
include::FirstSteps\CudaHelloWorld\CudaHelloWorld\kernel.cu[lines=26..27, indent =1]
